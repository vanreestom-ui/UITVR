...
function getModuleStatus() {
  return [
    { key: 'auth',     label: 'Authentification & Tableau de bord', status: 'active' },
    { key: 'faq',      label: 'FAQ & Annonces',                      status: 'coming' },
    { key: 'events',   label: 'Événements',                          status: 'coming' },
    { key: 'treasury', label: 'Trésorerie',                          status: 'coming' },
    { key: 'admin',    label: 'Interface Administration',            status: 'coming' },
  ];
}
